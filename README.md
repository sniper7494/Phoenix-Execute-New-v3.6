...
[![Stars](https://img.shields.io/github/stars/Phoenix-Execute-New-v3.6?style=flat-square)](https://github.com)
...
git clone https://github.com/Phoenix-Execute-New-v3.6.git
cd Phoenix-Execute-New-v3.6
